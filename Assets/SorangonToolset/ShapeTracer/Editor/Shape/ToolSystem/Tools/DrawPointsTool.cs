...
namespace SorangonToolset.ShapeTracer.Shapes.Tools {
	/// <summary>
	/// Draw points on the current shape in the shape editor window
	/// </summary>
	[ShapeTool("Draw", "Add or insert points on the shape", "Assets/SorangonToolset/ShapeTracer/Editor/Skin/Textures/T_Draw_Icon.png", 10)]
