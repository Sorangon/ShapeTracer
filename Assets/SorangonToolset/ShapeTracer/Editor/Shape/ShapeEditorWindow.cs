...
using UnityEngine;
using UnityEditor;
using SorangonToolset.ShapeTracer.Shapes.Tools;

namespace SorangonToolset.ShapeTracer.Shapes {
	/// <summary>
	/// The Shape editor window that allow you to create new shapes with a bunch of tools
	/// You can create your own tools inheriting ShapeEditorTool class, this one must belong to the same assembly
	/// </summary>
	public class ShapeEditorWindow : EditorWindow {
		...
		private void OnEnable() {
			...
			//Load skin
			_guiSkin = ShapeTracerResources.ShapeEditorGUISkin;
		}
